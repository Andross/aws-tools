...
parser = argparse.ArgumentParser(description='A python script used to check if the instances IP address has propogated to the TLD nameserver to ensure certbot gets the correct IP address when it performs its check.')
